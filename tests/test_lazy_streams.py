...
from jaf.jaf import jaf_stream
...
class TestLazyStreams:
    ...
    def test_complex_transformation(self):
        ...
        result = s.map([
            "dict",
            "display_name", ["upper-case", ["@", [["key", "name"]]]],
            "contact", ["@", [["key", "email"]]],
            "adult", ["gte?", ["@", [["key", "age"]]], 18]
        ])
    ...
    def test_jaf_stream_function(self):
        """Test the new jaf_stream function"""
        data = [
            {"name": "Alice", "age": 30},
            {"name": "Bob", "age": 25},
            {"name": "Charlie", "age": 35}
