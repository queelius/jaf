...
class TestAtSyntaxBasics:
    ...
    def test_at_string_with_wildcards(self):
        ...
        obj = {"products": [{"name": "A", "price": 100}, {"name": "B", "price": 200}]}
...
class TestAtSyntaxInPredicates:
    ...
    def test_exists_with_at_syntax(self):
        ...
        obj = {"user": {"name": "John", "email": "john@example.com"}, "settings": None}
...
class TestAtSyntaxComplexExpressions:
    ...
    def test_at_syntax_in(self):
        ...
        assert (
            jaf_eval.eval(query2, obj) == False
        )  # False because "admin" is not in permissions
        ...
        assert (
            jaf_eval.eval(query5, obj) == True
        )  # True because "read" is in permissions
    ...
    def test_nested_at_expressions(self):
        ...
        obj = {"user1": {"score": 100}, "user2": {"score": 85}, "threshold": 90}
...
class TestAtSyntaxErrorHandling:
    ...
    def test_at_with_wrong_argument_count(self):
        ...
        with pytest.raises(
            ValueError, match="'@' operator expects exactly one argument"
        ):
...
class TestAtSyntaxEquivalence:
    ...
    def test_equivalence_simple_paths(self):
        ...
        for case in test_cases:
            ...
            traditional = jaf_eval.eval(["@", path], obj)
    ...
    def test_equivalence_with_wildcards(self):
        ...
        traditional_result = jaf_eval.eval(["@", path], obj)
